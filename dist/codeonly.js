...
function nextFrame(callback, order)
{
    ...
    {
        getEnv().window.requestAnimationFrame(function() {
...
export { $, BrowserEnvironment, CloakedValue, Component, DocumentScrollPosition, EnvironmentBase, HtmlString, Notify, PageCache, Router, Style, Template, TransitionCss, TransitionNone, UrlMapper, ViewStateRestoration, WebHistoryRouterDriver, anyPendingFrames, cloak, css, getEnv, html, htmlEncode, input, nextFrame, notify, postNextFrame, router, setEnvProvider, transition, urlPattern };
